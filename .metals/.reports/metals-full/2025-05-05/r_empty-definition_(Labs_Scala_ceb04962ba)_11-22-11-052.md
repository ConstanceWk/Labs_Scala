error id: file://<WORKSPACE>/Lab3/Lab3_Ex1.scala:258
...
// 27. Define a Comparable[T] trait with methods isGreat@@erThan, isLessThan, and implement it for the Point class (compare by distance from origin).
```
